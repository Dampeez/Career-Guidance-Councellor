                                ...
                                <div class="profile-head media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="profile-details muted">
                                            <a href="esfppdf.php" class="btn"><i class="icon-plus shaded"></i>Download Report </a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="tab-pane fade active in" id="activity">
                                        ...
                                        <div class="module-body">
                                            <div class="row-fluid">
                                                    ...
                                                    <h3 style="text-align: center;">The Performer</h3>
                                                    <p style="text-align: justify;">Performers are born to be on stage and love the spotlight. They are unconstrained, fiery, and carefree, and enjoy the things around them. Usually warm, generous, and friendly, and always concerned about the following person’s well-being. </p><br>
                                                    
                                                    <h3 style="text-align: center;">Suitable Career Paths</h3>
                                                    <p style="text-align: justify;">Some career options or jobs best suited for 'Performers' include:</p>
                                                    <ul>



                                                        <li>Elementary Teacher</li><br>
                                                        <li>Recreation Worker.</li><br>
                                                        <li>Special Education Teacher</li><br>
                                                        <li>Physical Therapist</li><br>       
                                                    </ul>
                                            ...
                                            <div class="row-fluid">
                                                ...
                                                <p style="text-align: justify;">Based on your characteristic traits, we advise you to look at the options below and make an informed decision:</p><br><br><br><br><br><br>
                                                ...
                                                <th><h3>Course</h3></th>
                                                 ...
                                                 <th><h3>University</h3></th>
                                                  ...
                                                  <tr>
                                                      <td><p><b>Digital Media Design</b></p></td>
                                                      <td><p>BA – 3 Years </p></td>
                                                      <td><p><img src="images/table/uj.png"></p></td>
                                                  </tr>
                                                  <tr>
                                                  ...
                                                  <tr>
                                                      <td><p><b>Food and Beverage Operations </b></p></td>
                                                      <td><p>Diploma – 3 Years </p></td>
                                                      <td><p><img src="images/table/uj.png"></p></td>
                                                  </tr>
                                                  <tr>
                                                      <td colspan="3"><h4 style="text-align: center;">Sciences</h4></td>
                                                  </tr>
                                                  <tr>
                                                      <td><p><b>Physiology and Psychology </b></p></td>
                                                      <td><p>Bachelor of Science in Life and Environmental Science – 3 Years</p></td>
                                                      <td><p><img src="images/table/uj.png"></p></td>
                                                  </tr>
                                                  <tr>
                                                      <td colspan="3"><h4 style="text-align: center;">Education</h4></td>
                                                  </tr>
                                                  <tr>
                                                      <td><p><b>Foundation Phase </b></p></td>
